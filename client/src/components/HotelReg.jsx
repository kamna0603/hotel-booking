...
<div className='w-full mt-4 max-w-60 mr-auto'>
    ...
    <select  onChange={(e)=>setCity(e.target.value)} value={city} name="city" id="city" className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required>
...
<button type="submit" className='bg-gray-500 hover:bg-gray-600 transition-all text-white mr-auto px-6 py-2 rounded cursor-pointer mt-6'>Register</button>
