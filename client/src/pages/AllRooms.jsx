...
const filterDestination = (room)=>{
  ...
  // return room.hotel.city.toLowerCase().includes(destination.toLowerCase())
   const city = room.hotel?.city || room.hotel?.location || "";
  return city.toLowerCase().includes(destination.toLowerCase());
}

//Filter and sort rooms based on the selected filters and sort option
const filteredRooms = useMemo(() => {
  console.log("All rooms from context:", rooms);           // Is rooms empty?
  console.log("Destination:", searchParams.get('destination')); // Is destination set?
  
  return rooms
    .filter(room => {
      console.log("room.hotel:", room.hotel);              // Is hotel populated?
      console.log("room.hotel.city:", room.hotel?.city);  // Is city present?
      return matchesRoomType(room) && matchesPriceRange(room) && filterDestination(room);
    })
    .sort(sortRooms);
